...
public class BasicTeraSort extends Configured implements Tool {
    private static final Log LOG = LogFactory.getLog(org.apache.hadoop.examples.terasort.TeraSort.class);
    private static String SIMPLE_PARTITIONER = "mapreduce.terasort.simplepartitioner";
    private static String OUTPUT_REPLICATION = "mapreduce.terasort.output.replication";


    private static boolean getUseSimplePartitioner(JobContext job) {
    ...
    private static int getOutputReplication(JobContext job) {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("BasicTeraSort");
        job.setJarByClass(org.apache.hadoop.examples.terasort.TeraSort.class);
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(Text.class);
        job.setInputFormatClass(TeraInputFormat.class);
        job.setOutputFormatClass(TeraOutputFormat.class);
        if(useSimplePartitioner) {
            job.setPartitionerClass(org.apache.hadoop.examples.terasort.TeraSort.SimplePartitioner.class);
        } else {
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new org.apache.hadoop.examples.terasort.TeraSort(), args);
        System.exit(res);
    }
    ...
    private static class TotalOrderPartitioner extends Partitioner<Text, Text> implements Configurable {
