...
object FileEnumerator {
  ...
  def latteTestPositive(skip: Set[Int]): List[Test] = (1 to 23).toList filter (!skip.contains(_)) map { number =>
  ...
  def getWithResult: List[Test] =
    ...
    testOnPath("studenttests/gr5/assignment_of_null"),
    testOnPath("studenttests/gr5/assignment_of_cast_null"),
    ...
    testOnPath("studenttests/good/virtual/comparison"),
